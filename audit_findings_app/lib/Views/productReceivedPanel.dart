...
class ProductReceivedPanel extends StatefulWidget {


  @override
  _ProductReceivedPanelState createState() => _ProductReceivedPanelState();
}

class _ProductReceivedPanelState extends State<ProductReceivedPanel> {
  Function deleteTX;
  final List<ProductReceived> _userTransactions = [];
  //
  // ];
  int i = 0;
  int counter = 0;
  ...
  void _addNewTransaction(String invoice, DateTime date, int quantity, double amount, String code) {
    ...
    setState(() {
      ...
      AuditData.Owninstance.productReceivedList.add(newTX);
      _userTransactions.add(newTX);
    ...
    showModalBottomSheet(
        ...
        builder: (context) {
          return GestureDetector(
            onTap: () {},
            child: ProductReceivedTransaction(_addNewTransaction),
