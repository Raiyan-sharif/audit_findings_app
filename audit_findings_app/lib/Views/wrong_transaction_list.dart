...
class WrongTransactionList extends StatelessWidget {
  final List<WrongPaymentData> transactions;
  final Function deleteTX;
  WrongTransactionList(this.transactions,this.deleteTX);
