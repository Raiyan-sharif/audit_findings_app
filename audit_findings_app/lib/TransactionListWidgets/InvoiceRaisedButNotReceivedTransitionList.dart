...
class InvoiceRaisedButNotReceivedTransitionList extends StatelessWidget {
  final List<InvoiceRaisedNotReceived> transactions;
  final Function deleteTX;
  InvoiceRaisedButNotReceivedTransitionList(this.transactions,this.deleteTX);
