...
class UnderRateDiscountTransitionList extends StatelessWidget {
  final List<UnderrateProductSold> transactions;
  final Function deleteTX;
  UnderRateDiscountTransitionList(this.transactions,this.deleteTX);
