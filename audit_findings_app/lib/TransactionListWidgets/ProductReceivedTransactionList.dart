...
class ProductReceivedTransactionList extends StatelessWidget {
  final List<ProductReceived> transactions;
  final Function deleteTX;
  ProductReceivedTransactionList(this.transactions,this.deleteTX);
