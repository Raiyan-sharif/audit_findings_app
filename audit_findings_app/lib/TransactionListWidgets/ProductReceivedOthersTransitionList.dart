...
class ProductReceivedOthersTransitionList extends StatelessWidget {
  final List<ProductReceivedOthers> transactions;
  final Function deleteTX;
  ProductReceivedOthersTransitionList(this.transactions,this.deleteTX);
