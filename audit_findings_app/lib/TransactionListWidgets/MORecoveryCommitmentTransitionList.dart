...
class MORecoveryCommitmentTransitionList extends StatelessWidget {
  final List<MORecoveryCommitment> transactions;
  final Function deleteTX;
  MORecoveryCommitmentTransitionList(this.transactions,this.deleteTX);
