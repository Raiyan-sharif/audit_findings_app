...
class CustomerRecoveryCommittedTransitionList extends StatelessWidget {
  final List<CustomerRecoveryCommitment> transactions;
  final Function deleteTX;
  CustomerRecoveryCommittedTransitionList(this.transactions,this.deleteTX);
